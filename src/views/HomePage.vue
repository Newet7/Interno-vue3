    ...
    <div class="banner__content">
      <div class="banner__subcontent-box">
        <div class="bunner__subcontent">
          ...
          <p class="banner__subcontent-text">
  ...
  data() {
    return {
      ...
      listOfProjects: [
        {
          id: "first-project",
          src: require("@/assets/images/project-photo1.png"),
          alt: "first project",
        ...
        {
          id: "second-project",
          src: require("@/assets/images/project-photo2.png"),
          alt: "second project",
          firstparagraph: "Modern Kitchen",
          secondparagraph: "Decor / Artchitecture",
        },
        {
          id: "third-project",
          src: require("@/assets/images/project-photo3.png"),
          alt: "third project",
          firstparagraph: "Modern Kitchen",
          secondparagraph: "Decor / Artchitecture",
        },
        {
          id: "fourth-project",
          src: require("@/assets/images/project-photo4.png"),
          alt: "fourth project",
          firstparagraph: "Modern Kitchen",
          secondparagraph: "Decor / Artchitecture",
        },
      ...
      listOfBlogs: [
        {
          id: "first-blog",
          src: require("@/assets/images/blog-photo1.png"),
          alt: "first blog",
          tag: "Kitchen Design",
        ...
        {
          id: "second-blog",
          src: require("@/assets/images/blog-photo2.png"),
          alt: "second blog",
          tag: "Living Design",
        ...
        {
          id: "third-blog",
          src: require("@/assets/images/blog-photo3.png"),
          alt: "third blog",
          tag: "Interior Design",
